...
// `;
    ...
    return (
        <div 
            onClick={onClick} 
            className={`flex justify-center items-center border border-[#1F8FBF] rounded-[50%] w-12 h-12 text-[#1F8FBF] hover:bg-[#58B6DF] hover:text-white hover:border-[#58B6DF]
            ${selected? "bg-[#1F8FBF] text-white":""}`}>
            {num}
        </div>
    );
} 
