  ...
  return (
    <div className="font-orienta h-screen bg-[#F8F7F4] px-12 pt-20 pb-12 flex gap-9 text-black justify-center items-center">
      <div className="h-full w-[40%] rounded-lg border-2 border-[#B8B7AF] bg-white shadow-custom flex flex-col justify-center items-center p-24">
        ...
        />
        <button
          className="self-center w-52 px-5 py-3 text-white bg-[#1F8FBF] hover:bg-[#58B6DF] rounded-[12px] mt-8 mb-2"
          formAction={signup}
        >
          Sign up
        </button>
        <button
          className="self-center w-52 px-5 py-3 text-white bg-[#1F8FBF] rounded-[12px] hover:bg-[#58B6DF]"
          formAction={login}
        >
          Log in
        </button>
